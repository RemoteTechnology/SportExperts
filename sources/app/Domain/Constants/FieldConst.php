...
const FIELD_TOURNAMENT_KEY = 'tournament_key';
...
const FIELD_PAGINATE = 'paginate';
const FIELD_FILTER = 'filter';
const FIELD_ENABLE_EVENT = 'enable_events';
const FIELD_OWNER = 'owner';
const FIELD_ADMINS = 'admins';
const FIELD_OPTIONS = 'options';
const FIELD_PARTICIPANTS = 'participants';

const FIELD_WHO_USER = 'who_user';
const FIELD_AGE = 'age';
